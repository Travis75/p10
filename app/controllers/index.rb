...
get '/image_tag' do
  ...
  finished_haiku = Haiku.new(["pavement", "nobody", "empty", "line", "stairs", "stride", "road", "house", "industry", "street", "shadow", "energy", "sidewalk", "perspective", "picker", "building", "row", "daytime", "urban", "roof"])
  finished_haiku.create_haiku
